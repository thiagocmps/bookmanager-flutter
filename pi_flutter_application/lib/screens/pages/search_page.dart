...
return GestureDetector(
  onTap: () => _navigateToDetailPage(repo), // Navegar para a página de detalhes
  child: Card(
    elevation: 4, // Sombra para dar um efeito de profundidade
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.vertical(top: Radius.circular(12)), // Bordas arredondadas na parte superior
            image: DecorationImage(
              image: imageUrl.isNotEmpty
                  ? NetworkImage(imageUrl)
                  : AssetImage('assets/placeholder.png') as ImageProvider, // Placeholder se não houver imagem
              fit: BoxFit.cover,
            ),
          ),
        ),
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                repo['volumeInfo']['title'] ?? 'Título não disponível',
              ...
              const SizedBox(height: 4), // Espaçamento entre título e descrição
              Text(
                repo['volumeInfo']['description'] ?? 'Descrição não disponível',
                maxLines: 3,
                overflow: TextOverflow.ellipsis,
                style: const TextStyle(fontSize: 12),
              ),
              const SizedBox(height: 8), // Espaçamento antes da avaliação
              Row(
                children: [
